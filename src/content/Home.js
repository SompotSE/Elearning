            ...
            <Container fluid id="bg-home">
                ...
                <Row>
                    ...
                    <Col xs={24} md={24} xl={12} style={{ display: "flex", alignItems: "conter" }}>
                        <Row id="rowheadHome">
                            <Row id="headHome2"><Row>ความเป็นมา</Row></Row>
