            ...
            <Container fluid>
                <Row id="row-footer">
                    ...
                    <Col xs={13} md={6} xl={7} id="col-footer3">
                        ...
                        <Row>
                            <Col xs={4} md={2} xl={2} id="descript-footer3"><FaFacebookF style={{fontSize: "18px", color: "#FF7C00", marginRight: "3%"}}/></Col>
                        ...
                        <Row>
                            <Col xs={4} md={2} xl={2} id="descript-footer3"></Col>
                        ...
                        <Row>
                            <Col xs={4} md={2} xl={2} id="descript-footer2"><BiMessageRoundedEdit style={{fontSize: "18px", color: "#FF7C00", marginRight: "3%"}}/></Col>
