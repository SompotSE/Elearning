        ...
        return (
            <Container fluid>
                <Row id="row-footer1">
                    ...
                    <Col xs={24} md={12} xl={12} id="col-footer-logo">
                        <Image src={mhesi} fluid id="img-logo" style={{width: "13%", display: "flex", paddingTop: "0.8%", cursor: "pointer", height: "auto" }} onClick={() => { window.open("https://www.mhesi.go.th/", "_blank"); }}></Image>
